...
export const hubAndSpokePreset: Preset = {
  ...
  actors: [
    ...
    { id: 'client-1', name: 'Patient Health App', type: 'client-patient', networkId: 'network-n', idpId: 'idp-1' },
    { id: 'client-2', name: 'My Care Record', type: 'client-patient', networkId: 'network-s', idpId: 'idp-1' },
...
export const complexPreset: Preset = {
  ...
  actors: [
    ...
    { id: 'client-1', name: 'Patient Health App', type: 'client-patient', networkId: 'network-a', idpId: 'idp-1' },
    { id: 'client-2', name: 'My Care Record', type: 'client-patient', networkId: 'network-b', idpId: 'idp-1' },
    { id: 'client-3', name: 'Care Companion', type: 'client-patient', networkId: 'network-c', idpId: 'idp-2' },
    { id: 'client-4', name: 'Health Tracker', type: 'client-patient', networkId: 'network-d', idpId: 'idp-2' },
  ],
  edges: [
